...
# data = {
#     "welcome_message": {
#         "name": "simple_welcome_message 01",
#         "message_data": {
...
# get the welcome message ID: <Response [200]>
# {"welcome_message":{"id":"1468404540643110916","created_timestamp":"1638929898783","message_data":{"text":"Welcome, this is the train bot","entities":{"hashtags":[],"symbols":[],"user_mentions":[],"urls":[]}},"source_app_id":"22688263","name":"simple_welcome_message 01"},"apps":{"22688263":{"id":"22688263","name":"try_twitter_bot","url":"https:\/\/test-bot-g6.herokuapp.com"}}}

#####################################################
# this script create the welcome message with quick reply option
url = "https://api.twitter.com/1.1/direct_messages/welcome_messages/new.json"
